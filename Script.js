...
holder.style.image = "100px"
  ...
  // Essentially, on a click, the element will cycle through the arrays
    ...
    Placeholder.innerHTML = "<p>"+ "Written content: " + "<p>"+ firstJSON[holderCounter].written_content + "<br>" + "<br>" + "Translation: " + firstJSON[holderCounter].translation + "<br>" + "Location: " + firstJSON[holderCounter].location + "<br>" + "Language: " + firstJSON[holderCounter].language
